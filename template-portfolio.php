...
<header id="page-heading" class="clearfix">
    ...
    <?php 
        ...
        <ul id="portfolio-cats" class="filter clearfix">
            <li><a href="#" class="active button" data-filter="*"><span><?php _e('Tout', 'wpex'); ?></span></a></li>
            <?php
            foreach ($cats as $cat ) : ?>
            <li><a href="#" class="button" data-filter=".<?php echo $cat->slug; ?>"><span><?php echo $cat->name; ?></span></a></li>
            <?php endforeach; ?>
        </ul><!-- /portfolio-cats -->
	<?php } ?>	 
</header><!-- /page-heading -->
